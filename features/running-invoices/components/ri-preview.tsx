        ...
        <table style={{ width:'100%', borderCollapse:'collapse', fontSize:10 }}>
          <thead>
            <tr style={{ borderBottom:`1px solid ${RULE}`, background:BGROW }}>
              ...
              {ri.isIgst
                ? <><TH style={{ width:'7%', textAlign:'right' }}>IGST%</TH><TH style={{ width:'11%', textAlign:'right' }}>IGST (₹)</TH></>
                : <><TH style={{ width:'7%', textAlign:'right' }}>GST%</TH><TH style={{ width:'11%', textAlign:'right' }}>Tax (₹)</TH></>
              }
